...
final class SpotifyClientTests: XCTestCase {
    ...
    /// This is a really long test but I just wanted to test the client can
    /// handle dates without milliseconds
    func testCurrentUserRecentlyPlayedWithoutDecimalInDate() {
        let artist = SimplifiedArtist(
            externalUrls: ["spotify": "https://open.spotify.com/artist/5INjqkS1o8h1imAzPqGZBb"],
            href: "https://api.spotify.com/v1/artists/5INjqkS1o8h1imAzPqGZBb",
            id: "5INjqkS1o8h1imAzPqGZBb",
        ...
        // Date does not contain milliseconds
        let isoDate = "2016-12-13T20:44:04Z"
        let dateFormatter = DateFormatter()
          ...
          "items": [
            {
              ...
              "played_at": "2016-12-13T20:44:04Z",
              "context": {
                "uri": "spotify:artist:5INjqkS1o8h1imAzPqGZBb",
                "external_urls": {
                  "spotify": "https://open.spotify.com/artist/5INjqkS1o8h1imAzPqGZBb"
